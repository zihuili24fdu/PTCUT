...
# Pix2Pix测试脚本 - GNB 2-Class 节细胞神经母细胞瘤分类 (Baseline)
# 
...
echo "================================================================"
echo "Pix2Pix测试 (Baseline) - GNB 2-Class 节细胞神经母细胞瘤"
echo "================================================================"
echo "运行模式: $MODE"
echo "数据集目录: $DATAROOT"
echo "实验名称: $NAME"
...
if [ "$RUN_TEST" = true ]; then
    ...
    if [ ! -d "$CHECKPOINT_DIR" ]; then
        ...
        echo "请先运行训练脚本: bash train_pix2pix.sh"
        exit 1
    fi
